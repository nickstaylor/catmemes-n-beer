...
describe("FavoriteBreweries", ()=>{
  ...
  let mockUpdateFavoriteBreweries
  ...
  beforeEach(()=> {
    ...
    mockUpdateFavoriteBreweries = jest.fn()
    ...
    router = <BrowserRouter>
      <FavoriteBreweries
        ...
        updatefavoriteBreweries={mockUpdateFavoriteBreweries}
        favoriteBreweries={favoriteBreweries}
      />
      </BrowserRouter>
  })

  it('should display and array of all Favorited Breweries on render', ()=>{
  ...
  it('should show as many unfavorite star icons as there are the favorited breweries', ()=>{
  ...
  it('should show a message if there are no favorites and provide a link to the breweries page', () => {
    ...
    const message = getByText("No favorites yet! Check out some")
    const link = getByText("Breweries!")
    expect(link).toBeInTheDocument()
    expect(message).toBeInTheDocument()
    fireEvent.click(link)
    expect(window.location.href).toBe("http://localhost/breweries");
